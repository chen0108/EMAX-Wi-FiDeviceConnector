...
@property (nonatomic, assign) WiFiModule module;
...
@property (nonatomic, copy) void(^connectionTestResult)(NSString *mac);
@property (nonatomic, copy) void(^scanWiFiResult)(NSString *ssid, NSString *auth, NSString *encry);
//@property (nonatomic, copy) void(^setPswResult)();
//@property (nonatomic, copy) void(^setSSIDResult)();
@property (nonatomic, copy) void(^getMacResult)(NSString *mac);
@property (nonatomic, copy) void(^resultBlock)(BOOL isSuccess, NSUInteger taskPointer);
